...
export default function Hero() {
  ...
  const Asteroid = ({ className }: { className: string; key: number }) => {
  ...
  return (
    <div className={styles.hero}>
      <div className={styles.earthMediaWrapper}>
        <img
          className={styles.earthMedia}
          src={`./assets/images/home-earth.png`}
        />
        <img
          className={styles.satelliteImage}
          src={`./assets/images/home-satellite.png`}
        />
      </div>
      <div className={styles.asteroidContainer}>
        {Array(75)
          .fill(null)
          .map((index) => (
            <Asteroid key={index} className={styles.asteroid} />
          ))}
      </div>
      <div className={styles.mainLogoWrapper}>
        <img
          className={styles.mainLogo}
          src={`./assets/images/home-anant-logo.png`}
        />
      </div>
    </div>
  );
